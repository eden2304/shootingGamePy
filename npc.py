...
class NPC(AnimatedSprite):
    ...
    def check_wall_collision(self, dx, dy):
        if not(self.check_wall(int(self.x + dx * self.size), int(self.y))):
            self.x += dx
        if not(self.check_wall(int(self.x), int(self.y + dy * self.size))):
            self.y += dy
    ...
    def ray_cast_player_npc(self):
        ...
        for i in range(MAX_DEPTH):
            ...
            if tile_hor == self.map_pos:
                ...
                break
            if tile_hor in self.game.map.world_map:  # if its a wall
            ...
            for i in range(MAX_DEPTH):
                ...
                if tile_vert == self.map_pos:
                    ...
                    break
                if tile_vert in self.game.map.world_map:  # if its a wall
